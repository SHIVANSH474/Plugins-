...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "STRANGERHELLBOT")
    MY_GROUP = os.environ.get("YOUR_GROUP", "mastiwithfriendsx")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/SHIVANSH474/Hellbot")
