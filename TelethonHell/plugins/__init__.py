...
my_channel = Config.MY_CHANNEL or "STRANGERHELLBOT"
my_group = Config.MY_GROUP or "mastiwithfriendsx"
if "@" in my_channel:
    my_channel = my_channel.replace("@", "")
if "@" in my_group:
    my_group = my_group.replace("@", "")

chnl_link = "https://t.me/STRANGERHELLBOT"
grp_link = "https://t.me/mastiwithfriendsx"
hell_channel = f"[sᴛʀᴀɴɢᴇʀ ʜᴇʟʟʙᴏᴛ]({chnl_link})"
hell_grp = f"[sᴛʀᴀɴɢᴇʀ ᴡᴏʀʟᴅ]({grp_link})"
