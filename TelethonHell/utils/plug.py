...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        LOGS.info("⚡ sᴛʀᴀɴɢᴇʀ ʜᴇʟʟʙᴏᴛ ⚡ - Successfully Imported " + shortname)
...
async def plug_channel(client, channel):
    if channel != 0:
        LOGS.info("⚡ sᴛʀᴀɴɢᴇʀ ʜᴇʟʟʙᴏᴛ ⚡ - PLUGIN CHANNEL DETECTED.")
        LOGS.info("⚡ sᴛʀᴀɴɢᴇʀ ʜᴇʟʟʙᴏᴛ ⚡ - Starting to load extra plugins.")
