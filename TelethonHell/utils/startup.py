...
<b><i>»» <u><a href='https://t.me/STRANGERHELLBOT'>sᴛʀᴀɴɢᴇʀ ʜᴇʟʟʙᴏᴛ</a></u> ««</i></b>
"""
    await client.send_file(
        ...
        caption=text,
        parse_mode="HTML",
        buttons=[[Button.url("HellBot Network", "https://t.me/STRANGERHELLBOT")]],
    )
...
async def join_it(client):
    if client:
        try:
            await client(functions.channels.JoinChannelRequest("@STRANGERHELLBOT"))
